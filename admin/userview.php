...
if ($_SESSION['role'] == 'DEVELOPER') {
    ...
    ?>
                <li class="breadcrumb-item my-2"><a href="../leavemanagemet/applyleave.php">Apply</a></li>
                <li class="breadcrumb-item my-2"><a href="../leavemanagemet/viewleave.php">Pending</a></li>
                <li class="breadcrumb-item my-2"><a href="../leavemanagemet/history.php">History</a></li>
...
?>
    ...
    <div class="container my-5 shadow rounded mt-5 mb-5 bg-light">
        <div class="table-responsive">
         ...
         // $query = "SELECT * from tbl_leave,tbl_registration where  tbl_leave.user_id=tbl_registration.emp_id && firstname!='DEVELOPER'";
          
                 $query = "SELECT * FROM tbl_leave where user_id='$DEVELOPER'";
                    ...
                    while ($user = mysqli_fetch_assoc($fire)) {?>
                        <tr>
                            ...
                            <!--<td> <button type="butt    on" class="btn btn-primary btn-sm px-3" data-bs-toggle="modal"
